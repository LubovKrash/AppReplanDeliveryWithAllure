...
public class Generator {
    ...
    public static String enteredCity () {
        String[] cities = new String[]{"Пермь", "Красноярск", "Владикавказ", "Архангельск", "Вологда", "Нижний Тагил",
                "Новочеркасск", "Калининград", "Нетологорск", "Петрозаводск", "Тольятти", "Тамбов", "Волгоград", "Екатеринбург", "Пенза", "Сочи", "Ржев", "Рязань", "Москва", "Тверь", "Кызыл", "Владимир"};
